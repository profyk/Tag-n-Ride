...
type Ctx = {
  ...
  signUp: (body: { phone_number?: string; full_name: string; surname: string; pin: string; role: "passenger" | "driver" | "owner"; vehicle_plate?: string; id_number?: string; email?: string; password?: string; business_name?: string; driver_mode?: boolean; province: string; taxi_association_id?: string }) => Promise<User>;
