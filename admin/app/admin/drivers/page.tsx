    ...
    <AdminShell title="Driver Management">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="text-center cursor-pointer hover:border-cyan transition-colors"
          ...
          <Card className="text-center cursor-pointer hover:border-green transition-colors"
          ...
          <Card className="text-center cursor-pointer hover:border-yellow transition-colors"
