...
import { Download, TrendingUp, AlertCircle, RefreshCw, ArrowRight } from "lucide-react";
import {
  ...
  if (error) return (
    <AdminShell title="Financial Reports">
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <Button variant="secondary" onClick={loadData}><RefreshCw size={13} /> Try again</Button>
      </div>
    </AdminShell>
  );
  ...
  return (
    <AdminShell title="Financial Reports">
      <div className="space-y-6">
        ...
        {/* Reconciliation — link to dedicated page */}
        <Link href="/admin/reconciliation">
          <Card className="flex items-center justify-between hover:border-cyan/40 transition-colors cursor-pointer group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-text font-bold">Reconciliation</p>
                <p className="text-textMuted text-xs mt-0.5">Run reconciliation, view variance reports and resolve discrepancies</p>
              </div>
            </div>
            <ArrowRight size={16} className="text-textDim group-hover:text-cyan transition-colors flex-shrink-0" />
          </Card>
        </Link>
