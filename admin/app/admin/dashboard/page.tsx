      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {[
            ...
            { href: "/admin/daily-ops",     label: "Daily Ops",      color: "text-cyan border-cyan/20 hover:bg-cyan/5" },
            { href: "/admin/transactions",  label: "Transactions",   color: "text-textMuted border-border hover:bg-bg2" },
            { href: "/admin/pricing",       label: "Pricing Rules",  color: "text-textMuted border-border hover:bg-bg2" },
            { href: "/admin/fee-config",    label: "Fee Config",     color: "text-textMuted border-border hover:bg-bg2" },
