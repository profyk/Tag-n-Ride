        ...
        <form onSubmit={handleSubmit} className="bg-bg2 border border-border rounded-xl p-6 space-y-4">
          <div>
            ...
            <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)}
              placeholder="+27 800 000 000" required
          ...
          <div>
            ...
            <input type="password" value={pin} onChange={(e) => setPin(e.target.value)}
              ...
              className="w-full bg-bg border border-border rounded-md px-3 py-2.5 text-text text-sm placeholder:text-textDim focus:border-cyan transition-colors tracking-widest focus:outline-none" />
          </div>
